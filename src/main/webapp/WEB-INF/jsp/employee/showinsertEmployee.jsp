		...
		<div class="row">
			...
			<div class="table-responsive">
				<form class="form-horizontal" role="form"
					action="${ctx}/employee/insertEmployee" method="post"
					enctype="mutipart/form-data">
					<input type="hidden" name="flag" value="2"> <input
						type="hidden" name="id" value="${employee.id }">
					<div class="form-group">
						<label for="job_id" class="col-sm-2 control-label">职位</label>
						<div class="col-xs-3">
					...
					<div class="form-group">
						<label for="dept_id" class="col-sm-2 control-label">部门</label>
						<div class="col-xs-3">
					...
					<div class="form-group">
						...
						<label for="card_id" class="col-sm-2 control-label">身份证</label>
						<div class="col-xs-3">
							<input type="text" class="form-control" id="card_id"
								name="card_id" placeholder="请输入名字" value=>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<label for="party" class="col-sm-2 control-label">政治面貌</label>
						<div class="col-xs-3">
					...
					<div class="form-group">
						<label for="post_code" class="col-sm-2 control-label">邮政编码</label>
						<div class="col-xs-3">
					...
					<div class="form-group">
						<label for="race" class="col-sm-2 control-label">名族</label>
						<div class="col-xs-3">
							<input type="text" class="form-control" id="race" name="race"
								placeholder="请输入民族">

						</div>
						<label for="speciality" class="col-sm-2 control-label">所学专业</label>
						<div class="col-xs-3">
